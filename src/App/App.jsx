      ...
      <header className="bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold">Savannah Guide</span>
          </div>
          <div className="hidden md:flex space-x-8">
            <a href="#features" className="hover:text-orange-200 transition">
              Features
            </a>
            <a href="#audiences" className="hover:text-orange-200 transition">
              For You
            </a>
          ...
          <button className="bg-orange-500 hover:bg-orange-400 px-6 py-2 rounded-full transition">
            Try Demo
          </button>
        </nav>
